...
\begin{frame}{Fonctionnement}{Proof-of-work}
	\only<1-2>{
	\begin{center}
		\includegraphics[scale=0.4]{mining.png}
	\end{center}
	\begin{center}
		\textbf{Proof-of-work} est un algorithme de consensus dans un réseau de Blockchain. Cet algorithme est utilisé pour confirmer les transactions et produire des nouveaux blocks dans la chaine en prouvant que des calculs informatiques onéreux ont été fait.
	\end{center}
	\begin{center}
		\begin{itemize}
